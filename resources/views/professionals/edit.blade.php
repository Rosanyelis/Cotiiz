@extends('layouts.app')
@section('title', 'Profesionales - Editar')
@section('content')
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Editar Profesional</h5>

                    <a href="{{ route('professional.index') }}" class="btn btn-sm btn-secondary"><i
                            class="ri-arrow-left-line me-1"></i> Regresar</a>
                </div>
                <form class="needs-validation" action=" {{ route('professional.update', $data->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-6 col-md-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" id="name" name="second_lastname"
                                        ...
                                        value="{{ old('second_lastname', $data->second_lastname) }}" />
                            ...
                            <div class="col-md-4">
                                <div class="form-floating form-floating-outline mb-5">
                                    ...
                                    id="country" name="country" value="{{ old('country', $data->country) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-floating form-floating-outline mb-5">
                                    ...
                                    id="state" name="state"  value="{{ old('state', $data->state) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-floating form-floating-outline mb-5">
                                    ...
                                    id="city" name="city"  value="{{ old('city', $data->city) }}"
                            ...
                            <div class="col-md-8">
                                <div class="form-floating form-floating-outline mb-5">
                                    ...
                                    id="address" name="address"  value="{{ old('address', $data->address) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-floating form-floating-outline mb-5">
                                    ...
                                    id="zip" name="zip"  value="{{ old('zip', $data->zip) }}"
                            ...
                            <div class="mb-6 col-md-4">
                                <div class="form-floating form-floating-outline">
                                    ...
                                    placeholder="Selecione la Profesión">
                                        ...
                                        <option value="{{ $item->id }}" {{ old('occupation_id', $data->occupation_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-6 col-md-4">
                                <div class="form-floating form-floating-outline">
                                    ...
                                    placeholder="Selecione la Especialidad">
                                        ...
                                        <option value="{{ $item->id }}" {{ old('specialty_id', $data->specialty_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating form-floating-outline mb-5">
                                    ...
                                    id="facebook" name="facebook"  value="{{ old('facebook', $data->facebook) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-floating form-floating-outline mb-5">
                                    ...
                                    id="instagram" name="instagram"  value="{{ old('instagram', $data->instagram) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-floating form-floating-outline mb-5">
                                    ...
                                    id="twitter" name="twitter"  value="{{ old('twitter', $data->twitter) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-floating form-floating-outline mb-5">
                                    ...
                                    id="linkedin" name="linkedin"  value="{{ old('linkedin', $data->linkedin) }}"
