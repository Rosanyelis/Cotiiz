        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Nuevo Servicios</h5>

                    <a href="{{ route('service.index') }}" class="btn btn-sm btn-secondary"><i
                            class="ri-arrow-left-line me-1"></i> Regresar</a>
                </div>
                <form class="needs-validation" action=" {{ route('service.store') }}" method="POST"
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-6">
                            ...
                            <div class="button-wrapper">
                                <label for="upload" class="btn btn-primary me-3 mb-4" tabindex="0">
                                    <span class="d-none d-sm-block">Cargar imagen de Servicio (opcional)</span>
                            ...
                            <div class="mb-6 col-md-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="number" id="price" name="price"
                                        ...
                                        placeholder="Ingrese precio del servico"
                                        value="{{ old('price') }}" />
