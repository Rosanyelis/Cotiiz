                            ...
                            <h6>1. Información de Empleado</h6>
                                <div class="mb-6 col-md-6">
                                    <div class="form-floating form-floating-outline">
                                        <select id="rfcbussines_id" name="rfcbussines_id" class="form-select select2"
                                            placeholder="Selecione una Empresa">
                                            <option value="">-- Seleccionar --</option>
                                            @foreach($rfcs as $item)
                                            <option value="{{ $item->id }}" {{ old('rfcbussines_id') == $item->id ? selected : '' }} >{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                        <label for="rfcbussines_id">Empresa</label>
                                        @if($errors->has('rfcbussines_id'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('rfcbussines_id') }}
                                        </div>
                                        @endif
                                    </div>
                                </div>
