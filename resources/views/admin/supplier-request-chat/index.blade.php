@extends('layouts.app')
@section('title', 'Solicitudes de Proveedor - Chat')
@section('css')
    <!-- Vendors CSS -->
                    ...
                    <div class="chat-history-header border-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex overflow-hidden align-items-center">
                                ...
                                <div class="chat-contact-info flex-grow-1 ms-4">
                                    <h4 class="m-0 fw-bold">{{ $data->supplier->name  }}</h4>
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center" >
                                <div class="flex-grow-1">
                                    <h6 class="m-0 fw-bold">Proveedor</h6>
                                    <p class="text-body">{{ $data->supplier->name  }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex align-items-center" >
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-body">{{ $data->observation  }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
