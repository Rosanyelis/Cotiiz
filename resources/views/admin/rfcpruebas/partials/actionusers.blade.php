...
<div class="dropdown-menu dropdown-menu-end m-0" style="">
        <a class="dropdown-item text-primary" href="{{ route('prueba.users.show_users', ['cliente' => $data->rfc_prueba_id, 'user' => $data->id]) }}">
            <i class="ri-eye-fill ri-20px"></i>
            Ver Usuario
        </a>
        <a class="dropdown-item text-info" href="{{ route('prueba.users.edit_users', ['cliente' => $data->rfc_prueba_id, 'user' => $data->id]) }}">
