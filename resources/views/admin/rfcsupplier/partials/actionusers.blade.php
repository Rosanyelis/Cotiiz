...
<div class="dropdown-menu dropdown-menu-end m-0" style="">
        <a class="dropdown-item text-primary" href="{{ route('supplier.users.show_users', ['cliente' => $data->rfc_suppliers_id, 'user' => $data->id]) }}">
            <i class="ri-eye-fill ri-20px"></i>
            Ver Usuario
        </a>
        <a class="dropdown-item text-info" href="{{ route('supplier.users.edit_users', ['cliente' => $data->rfc_suppliers_id, 'user' => $data->id]) }}">
