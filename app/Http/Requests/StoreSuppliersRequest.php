...
class StoreSuppliersRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'file_credit_acceptance_letter'       => ['required', 'mimes:pdf', 'max:2048'],
            'file_list_product_service' => ['required', 'mimes:pdf', 'max:2048'],
            'phone'                     => ['required'],
    ...
    public function messages()
    {
        return [
            ...
            'file_credit_acceptance_letter.required' => 'El campo es obligatorio',
            'file_credit_acceptance_letter.mimes' => 'El archivo debe ser PDF',
            'file_credit_acceptance_letter.max' => 'El archivo no debe ser mayor a 2MB',
            'file_list_product_service.required' => 'El campo es obligatorio',
            'file_list_product_service.mimes' => 'El archivo debe ser PDF',
            'file_list_product_service.max' => 'El archivo no debe ser mayor a 2MB',
            ...
            'email.lowercase' => 'El campo es obligatorio',
            'email.email' => 'El campo es obligatorio',
