...
$(function () {
    ...
    if (dt_ajax_table.length) {
        var dt_ajax = dt_ajax_table.dataTable({
            processing: true,
            serverSide: true,
            ajax: "/gestion-de-usuarios-proveedores",
            dataType: 'json',
            type: "POST",
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href =
                "/gestion-de-usuarios-proveedores/"+id+"/activated";
        }
    })
}
...
function desactivarRecord(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href =
                "/gestion-de-usuarios-proveedores/"+id+"/desactivated";
        }
    })
}
...
function deleted(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href =
                "/gestion-de-usuarios-proveedores/"+id+"/deleted";
        }
    })
}
