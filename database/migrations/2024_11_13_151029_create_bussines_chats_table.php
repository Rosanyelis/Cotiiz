...
return new class extends Migration
{
    ...
    {
        Schema::create('bussines_chats', function (Blueprint $table) {
            $table->id();
            $table->foreignId('rfc_bussines_id')->constrained('rfc_bussines')->onDelete('cascade');
            $table->foreignId('user_bussines_id')->constrained('users')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('bussines_chats');
    }
};
